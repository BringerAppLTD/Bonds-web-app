        ...
        <div style={{ color:'white',  width: '80%', marginTop:0, float:'left' }}> 
                  ...
                  <div style={{display: 'flex', marginTop:20}}>
                    ...
                    <div style={{overflowY:'auto', lineHeight:0.1, paddingTop:36, paddingBottom:30}}>
                        <input type="text" placeholder="search with name of song or name of artist or bonds username" style={{width: 200, height: 20, fontSize:12, padding: 6, border: '1px solid yellow'}}/>
                    </div>
